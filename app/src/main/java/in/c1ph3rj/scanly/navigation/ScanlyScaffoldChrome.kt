...
@Composable
internal fun ScanlyNavigationBar(
    currentRoute: String?,
...
@Composable
internal fun ScanlyNavigationRail(
    currentRoute: String?,
    onNavigate: (String) -> Unit,
) {
...
@Composable
internal fun TopLevelDestinationShell(
...
internal fun navigateToTopLevel(navController: NavHostController, route: String) {
