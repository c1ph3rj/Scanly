...
import `in`.c1ph3rj.scanly.data.document.DefaultDocumentGroupRepository
...
abstract class DocumentDataModule {
    ...
    @Binds
    @Singleton
    abstract fun bindDocumentGroupRepository(
        repository: DefaultDocumentGroupRepository,
